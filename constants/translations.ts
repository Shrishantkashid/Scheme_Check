export const translations = {
  en: {
    ...
    access_suite: "Find and access government welfare schemes you are eligible for.",
    ...
    join_circle: "Create an account to discover government schemes tailored to you.",
    full_name: "Full Name",
  ...
  kn: {
    ...
    access_suite: "ನಿಮಗೆ ಅರ್ಹವಾದ ಸರ್ಕಾರಿ ಕಲ್ಯಾಣ ಯೋಜನೆಗಳನ್ನು ಹುಡುಕಿ ಮತ್ತು ಪ್ರವೇಶಿಸಿ.",
    ...
    join_circle: "ನಿಮಗೆ ಅನುಗುಣವಾಗಿ ಸರ್ಕಾರಿ ಯೋಜನೆಗಳನ್ನು ಅನ್ವೇಷಿಸಲು ಖಾತೆಯನ್ನು ರಚಿಸಿ.",
